...
float Version = 0.002; // Version der Software
...
int Magtyp[8] = {6, 10, 12, 15, 18, 25, 35, 0}; // Arry für Magazingrössen  (0=6/1=10/2=12/3=15/4=18/5=25/6=35/7=0=Hochzählen)
int Mag = 4; // Variable für das Magazin aus dem Array Standard = 4 = 18
int AMMO = Magtyp[Mag]; // Variable für den Munitionscounter - Setzte Startwert = Größe des Standardmagazins
